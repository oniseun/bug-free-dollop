...
describe('UserController', () => {
  ...
  describe('getUser', () => {
    ...
    it('should throw NotFoundException when user not found', async () => {
      ...
      await expect(userController.getUser(999, mockAdmin)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('update', () => {
    ...
    it('should throw ForbiddenException when non-admin tries to update another user', async () => {
      ...
      await expect(
        userController.updateUser(999, updateUserDto, mockUser),
  ...
  describe('delete', () => {
    ...
    it('should throw ForbiddenException when user tries to delete themselves', async () => {
      ...
      await expect(userController.delete(2, mockUser)).rejects.toThrow(
        ForbiddenException,
      );
    });
    ...
    it('should throw ForbiddenException when non-admin tries to delete another user', async () => {
      ...
      await expect(userController.delete(999, mockUser)).rejects.toThrow(
        ForbiddenException,
      );
    });
  });
